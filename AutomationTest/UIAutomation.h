...
/*
 * This file was crated by running class-dump against the UIAutomation Framework (path noted below)
 * In addition, the following modifcations were performed:
 * 
 * • Removed redeclarations of CG framework structs
 * • Added forward declarations as required to eliminate compiler warnings
 * • Organzed classes as appropriate to enable compilation
 * • Added weak ref to member of CDStruct_11f37819 to enable compilation in ARC mode
 */
...
/*
 * File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk/Developer/Library/PrivateFrameworks/UIAutomation.framework/UIAutomation
 * UUID: 408C8B0F-8FA0-355E-B1D6-626B9DD085F0
 * Arch: i386
...
// forward declarations to eliminate warnings
